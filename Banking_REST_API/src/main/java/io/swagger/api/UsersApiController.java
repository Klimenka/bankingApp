...
public class UsersApiController implements UsersApi {
    ...
    public ResponseEntity<User> addUser(@ApiParam(value = "" ,required=true )  @Valid @RequestBody Object body) {
    ...
    public ResponseEntity<User> getUserById(@Min(1L)@ApiParam(value = "The id of the user to return",required=true, allowableValues = "") @PathVariable("userId") Long userId) {
        String accept = request.getHeader("Accept");
        return new ResponseEntity<User>(HttpStatus.NOT_IMPLEMENTED);
    }

    public ResponseEntity<List<User>> getUsers(@ApiParam(value = "", allowableValues = "Customer, Employee") @Valid @RequestParam(value = "userType", required = false) String userType) {
        String accept = request.getHeader("Accept");
